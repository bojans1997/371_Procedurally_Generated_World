...
Sector::Sector(float sA1, float sA2, float r, float s1, float s2) stackAngle1(sA1), stackAngle2(sA2), radius(r), sectorAngle(s1), sectorAngle2(s2) {
	...
	float x2 = (radius*cos(stackAngle1))*sin(sectorAngle2);
	float y2 = (radius*sin(stackAngle1));
	float z2 = (radius*cos(stackAngle1))*cos(sectorAngle2);
	
	float x3 = (radius*cos(stackAngle2))*sin(sectorAngle1);
	float y3 = (radius*sin(stackAngle2));
	float z3 = (radius*cos(stackAngle2))*cos(sectorAngle1);
